...
test_group('beson testing', ()=>{
	test_group('beson deserialize data is equal to origin data', ()=>{
		unit_test('Null', ()=>{
			let origin = null;
		...
		unit_test('Int8 (posunit_testive object)', ()=>{
		...
		unit_test('Int16 (posunit_testive object)', ()=>{
		...
		unit_test('Int32 (posunit_testive object)', ()=>{
		...
		unit_test('Int64 (posunit_testive number)', ()=>{
		...
		unit_test('Int128 (posunit_testive number)', ()=>{
		...
		unit_test('Array (streaming + append binary origin)', ()=>{
			let origin = [true, 2147483647, Math.PI, {aaa: 2147483647, bbb: Math.PI}, [false, 'Hello World', new Date(1539838676247), Int128.from(Int128.MAX)]];
		...
		unit_test('Object (streaming + append binary origin)', ()=>{
			let origin = {
				z: {
					c: 'aaa',
					b: false,
		...
		unit_test('Binary', ()=>{
			let origin = Binary.FromArrayBuffer(Serialize(new ObjectId()));
			let test = Deserialize(Serialize(origin));
			assert(test.toString() === origin.toString());
		});
		...
		unit_test('Uint32Array', ()=>{
			let origin = Binary.FromArrayBuffer(Serialize(new ObjectId())).cut(0, 12);
		...
		unit_test('Float64Array', ()=>{
			let origin = Binary.FromArrayBuffer(Serialize(new ObjectId())).cut(0, 8);
	...
	test_group('UTF8 decode data is equal to origin data', ()=>{
